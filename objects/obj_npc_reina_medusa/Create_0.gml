...
saludMax = 10000; // La vida es igual a la del manual
salud = saludMax;
...
experiencia = 30000; // La experiencia es igual a la del manual

// Oro otorgado al morir

oro = obj_pj.modOro * 3000; // El oro es igual al del manual
