...
if (obj_ayuda.mostrado) {
    ...
    x = __view_get( e__VW.XView, 0 ) + __view_get( e__VW.WView, 0 ) * 0.5 + 384 * 0.5 - 2;
    y = __view_get( e__VW.YView, 0 ) + __view_get( e__VW.HView, 0 ) * 0.5 + 216 * 0.5 - 2;
    visible = true;
    ...
    device_mouse_check_button(4, mb_left)
        ...
        if (device != -1) {
            ...
            if (device_mouse_check_button_pressed(device, mb_left) && position_meeting(device_mouse_x(device), device_mouse_y(device), self)) {
                ...
                if (obj_manual.pagina < obj_manual.totalPaginas) {
                    obj_manual.pagina++;
                } else {
                    obj_manual.pagina = 0;
                }
