...
saludMax = 15000; // La vida es igual a la del manual
salud = saludMax;
...
evasion = 100; // La evasión es igual a la del manual

// Experiencia otorgada al morir

experiencia = 2000; // La experiencia es igual a la del manual
