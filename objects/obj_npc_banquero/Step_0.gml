            ...
            if (!dobleClic) {
                ...
                if (!obj_pj.muerto) {
                    ...
                    if (obj_panel_items.mostrado) {
                        ...
                        obj_panel_items.idBanquero = -1;
                        obj_panel_items.mostrado = false;
                        obj_panel_items.modoBanco = false;
                    } else {
                        obj_panel_trabajos.mostrado = false;   
                        obj_panel_items.idPadre = obj_banco.id;
                        obj_panel_items.idBanquero = id;
                        obj_panel_items.mostrado = true;
                        obj_panel_items.modoBanco = true;
                    }
                } else {
