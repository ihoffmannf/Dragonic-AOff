...
saludMax = 250; // La vida es igual a la del manual
salud = saludMax;
...
experiencia = 200; // La experiencia es igual a la del manual

// Oro otorgado al morir

oro = obj_pj.modOro * 70; // El oro es igual al del manual
