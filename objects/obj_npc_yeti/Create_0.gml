...
saludMax = 17500; // La vida es igual a la del manual
salud = saludMax;
...
evasion = 125; // La evasión es igual a la del manual

// Experiencia otorgada al morir

experiencia = 3200; // La experiencia es igual a la del manual
