...
saludMax = 23000; // La vida es igual a la del manual
salud = saludMax;
...
experiencia = 75000; // La experiencia es igual a la del manual

// Oro otorgado al morir

oro = obj_pj.modOro * 4200; // El oro es igual al del manual
