...
saludMax = 20000; // La vida es igual a la del manual
salud = saludMax;
...
evasion = 150; // La evasión es igual a la del manual

// Experiencia otorgada al morir

experiencia = 4000; // La experiencia es igual a la del manual

// Oro otorgado al morir

oro = obj_pj.modOro * 10000; // El oro es igual al del manual
