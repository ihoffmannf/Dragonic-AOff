...
saludMax = 350; // La vida es igual a la del manual
salud = saludMax;
...
experiencia = 350; // La experiencia es igual a la del manual

// Oro otorgado al morir

oro = obj_pj.modOro * 150; // El oro es igual al del manual
