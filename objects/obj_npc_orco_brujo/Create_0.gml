...
envenena = false;
target = -1;
objHechizo = obj_misil_magico;
sndHechizo = snd_misilMagico;
...
saludMax = 1200; // La vida es igual a la del manual
salud = saludMax;
...
experiencia = 1500; // La experiencia es igual a la del manual

// Oro otorgado al morir

oro = obj_pj.modOro * 800; // El oro es igual al del manual
